...
La migration de ce site est enfin terminée et basée sur une architecture de type [JAMStack](http://ducamp.me/JAMStack) soufflée par <span class="h-card">[Bertrand](https://bertrandkeller.info)</span> chez JamStatic : 
